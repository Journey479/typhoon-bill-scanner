...
**บันทึกลงแท็บ `Error` ด้วย** — ทุกเอกสารที่ย้ายเข้า Error folder จะเพิ่ม 1 แถวในแท็บ `Error` ของชีต (สร้าง/เติมหัวข้ออัตโนมัติ) เพื่อให้คนเปิดดูรูปแล้วกรอกรายละเอียดเองต่อได้ถ้าอ่านออก คอลัมน์: `ชื่อไฟล์`, `ประเภทบิล`, `รายละเอียดของError`, `ลิงก์รูปภาพใน Drive`, `TimeStamp`, `Model`, `เวลาที่ใช้ประมวลผล (วินาที)`
